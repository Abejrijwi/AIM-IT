    ...
    <div class="layout-content-body">
        <div class="title-bar">
            <h1 class="title-bar-title">
                ...
                <a href="<?php echo base_url('dashboard/listresults');?>"><i class="icon icon-list"></i></a>
                    ...
                    <form class="form form-horizontal" action="<?php echo $action ?>" method="post" id="demo-inputmask"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select id="form-control-1" class="form-control" name="course" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input required type="text" class="form-control" name="corceyr" value="" id="corceyr"  placeholder="Enter Date" data-date-autoclose="true">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select required id="form-control-1" class="form-control" name="crc_yr">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea required name="descrption" class="form-control"  placeholder="Enter Description"></textarea>
                                <span style="color:red;"><?php echo form_error('descrption'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input required id="form-control-1" name="quesfile" type="file">
